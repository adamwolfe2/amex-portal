  ...
  if (loading) {
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        {/* Header skeleton */}
        <div>
          <div className="h-5 w-28 bg-[#f0efed] rounded animate-pulse mb-2" />
        ...
        <div className="border border-[#e0ddd9] rounded-lg bg-white p-6">
          <div className="flex flex-col items-center gap-3">
            <div className="h-8 w-8 bg-[#f0efed] rounded animate-pulse" />
            <div className="h-5 w-64 bg-[#f0efed] rounded animate-pulse" />
            <div className="h-4 w-80 bg-[#f0efed] rounded animate-pulse" />
            <div className="flex gap-2 mt-2">
              {[1, 2, 3].map((i) => (
                <div key={i} className="h-8 w-36 bg-[#f0efed] rounded-lg animate-pulse" />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="border border-[#e0ddd9] rounded-lg bg-white p-5">
          ...
          <div className="h-10 bg-[#f0efed] rounded-lg animate-pulse" />
        </div>
        {/* Stats skeleton */}
        <div className="grid grid-cols-3 gap-2 sm:gap-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="border border-[#e0ddd9] rounded-lg bg-white p-3 sm:p-4">
              <div className="flex flex-col items-center gap-1.5">
                <div className="h-4 w-4 bg-[#f0efed] rounded animate-pulse" />
                <div className="h-6 w-10 bg-[#f0efed] rounded animate-pulse" />
        ...
        <div className="border border-[#e0ddd9] rounded-lg bg-white">
          <div className="px-5 py-3 border-b border-[#e0ddd9]">
            <div className="h-4 w-16 bg-[#f0efed] rounded animate-pulse" />
          </div>
          <div className="divide-y divide-[#e0ddd9]">
            {[1, 2, 3].map((i) => (
              <div key={i} className="px-5 py-3">
                <div className="h-4 w-40 bg-[#f0efed] rounded animate-pulse mb-2" />
                <div className="h-3 w-28 bg-[#f0efed] rounded animate-pulse" />
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="border border-[#e0ddd9] rounded-lg bg-white">
        ...
        {!data?.referrals.length ? (
          <div className="text-center py-12 px-4">
            <UserPlus className="h-8 w-8 text-[#999999] mx-auto mb-3" />
            <p className="text-sm font-medium text-[#111111]">No referrals yet</p>
            <p className="text-xs text-[#666666] mt-1 max-w-xs mx-auto">
              Share your referral link with friends and earn 30% commission on every Pro upgrade
            </p>
            <Button
              variant="outline"
              size="sm"
